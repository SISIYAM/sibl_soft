...
<!-- Activated & Deactivated Code Start -->
...
<?php
  ...
  if(isset($_POST['Activated'])){
   ...
   <!-- Activated & Deactivated Code End -->
    ...
    <!---start---->
              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Account Type - <b style="font-weight:700; color:#000000;"><?php

include 'dbcon.php' ;
$category_query = " select * from  category where c_id='$cid' ";
...
?> </b></h2>
        ...
        <?php
$no = 1 ;
$selectquery = " select * from  accounts where type=$cid";
